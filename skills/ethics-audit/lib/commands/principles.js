...
export function queryPrinciples(ethics, query) {
    let items = ethics.items;
...
/** 照会結果を人間可読テキストに整形する。 */
export function formatPrinciplesText(ethics, result) {
...
export function runPrinciples(query, format) {
